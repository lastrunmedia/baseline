...
/*
 *
 *This code was originally pulled from the Hide Title plugin by http://dojodigital.com (Version: 1.0.8) and adapted for Baseline.
 *
*/


if ( !class_exists( 'BaselineHideTitle' ) ) {

    class BaselineHideTitle {

    	private $slug = 'baseline_toggle_title';
...
<style type="text/css"> body.baseline-hide-title .entry-title { display:none !important; }</style>
<!-- End Baseline Hide Title -->

			<?php 
									
				add_filter( 'body_class', function( $classes ) {
					return array_merge( $classes, array( 'baseline-hide-title' ) );
				} );						
		...
		public function build_box( $post ){
			...
			?>
			<label><input type="checkbox" name="<?php echo $this->slug; ?>" <?php echo $checked; ?> /> Hide the title on single views.</label>
			<?php
    ...
    $BaselineHideTitle = new BaselineHideTitle;

} // !class_exists( 'BaselineHideTitle' )